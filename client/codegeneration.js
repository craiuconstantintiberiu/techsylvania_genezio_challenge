export function createImportService(className, savedData) {
...
export function createSymfonyXMLFile(entityName, tableName, data) {
...
export function createSymfonyEntityClass(namespace, className, data) {
    let entity = `<?php`
    entity += `\n\nnamespace ${namespace};`
